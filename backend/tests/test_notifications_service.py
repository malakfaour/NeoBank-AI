...
@pytest.mark.anyio
@pytest.mark.parametrize("notification_type", sorted(EMAIL_WORTHY_TYPES))
async def test_notify_sends_email_for_email_worthy_types(monkeypatch, notification_type):
    sent_email = {}
